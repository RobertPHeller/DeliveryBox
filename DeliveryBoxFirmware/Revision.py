...
outputhxx = ''
outputdoc = '/** @page Revision Build Revisions'
...
if main_git_hash is not None:
    ...
    outputdoc += "\n * - Program Name: " + os.path.split(os.path.abspath(orig_dir))[1]
    outputdoc += "\n * - Git Hash: " + main_git_hash

os.chdir(orig_dir)

# generate the *.hxxout file
output_file = open(options.output + 'Try.h', 'w')
output_file.write(outputdoc + "\n */\n\n")
